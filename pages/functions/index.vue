...
export default {
  ...
  head () {
    const title = 'Functions :: KuriyamaBot'
    const { meta, link } = buildmeta({
      title,
      url: 'https://kuriyama.mori.space/functions',
